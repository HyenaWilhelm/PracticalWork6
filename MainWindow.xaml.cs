...
namespace PracticalWork6
{
    ...
    public partial class MainWindow : Window
    {
        ...
        private void ConnectButton_Click(object sender, RoutedEventArgs e)
        {
            ...
            {
                MessageBox.Show("Подалуйста введите верное имя пользователя (допускаются только цифры и буквы).", "Неверный юзернейм", MessageBoxButton.OK, MessageBoxImage.Warning);
                return;
            }
            ...
            if (ConnectChatRadioButton.IsChecked == true)
            {
                ...
                {
                    MessageBox.Show("Пожалуйста введите правильный ip.", "Неверный ip адресс", MessageBoxButton.OK, MessageBoxImage.Warning);
                    return;
                }
